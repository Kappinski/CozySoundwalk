...
public class RandomAudioPlayer : MonoBehaviour
{
    ...
    public AudioSource allMyAudio;


    // Start is called before the first frame update
    void Start()
    {
        // allMyAudio = gameObject.GetComponent<AudioSource>();
    ...
    {
        // int rand = Random.Range(0, allMyAudio.Length-1);
        allMyAudio.panStereo = Random.Range(-0.8f, 0.8f);
        allMyAudio.Play();
        return;
    }
